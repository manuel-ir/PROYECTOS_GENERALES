...
import com.examenud3.entidades.*;
...
public class MainExamen {
    public static void main(String[] args) {
        ...
        Asignatura a6 = new Asignatura(6, "FOL", "primero");
        Asignatura a7 = new Asignatura(7, "Sistemas de gestión", "segundo");
        Asignatura a8 = new Asignatura(8, "Programación servicios", "segundo");
        Asignatura a9 = new Asignatura(9, "Acceso a datos", "segundo");
        Asignatura a10 = new Asignatura(10, "Desarrollo Interfaces", "segundo");
        Asignatura a11 = new Asignatura(11, "Multimedia", "segundo");
        Asignatura a12 = new Asignatura(12, "Empresa e iniciativa", "segundo");
        ...
        // Persistir Profesores (y asignaturas por cascada)
